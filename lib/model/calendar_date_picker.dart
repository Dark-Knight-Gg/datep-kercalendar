...
enum CalendarDatePickerType { single, multi, range }
...
class RangeDatePickerConfig {
  RangeDatePickerConfig({
    CalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
  ...
  })  : calendarType = calendarType ?? CalendarDatePickerType.single,
  ...
  final CalendarDatePickerType calendarType;
  ...
  RangeDatePickerConfig copyWith({
    CalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
...
class DateRangePickerButtonConfig
    extends RangeDatePickerConfig {
  DateRangePickerButtonConfig({
    CalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
  ...
  @override
  DateRangePickerButtonConfig copyWith({
    CalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    return DateRangePickerButtonConfig(
      calendarType: calendarType ?? this.calendarType,
      firstDate: DateUtils.dateOnly(firstDate ?? this.firstDate),
      lastDate: DateUtils.dateOnly(lastDate ?? this.lastDate),
      currentDate: currentDate ?? this.currentDate,
